...
#' \code{coord_cartesian(...)}. This way data points outside the axis-limit are only hidden when
#' plotting. Setting axis-limits using e.g. \code{scale_x_continuous}, \code{scale_x_log10}, or
